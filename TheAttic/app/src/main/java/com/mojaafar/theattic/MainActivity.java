...
public class MainActivity extends AppCompatActivity {
    ...
    private void updateUI(final FirebaseUser currentUser) {
        ...
        adapter = new FirebaseRecyclerAdapter<Attic, AtticViewHolder>(options) {
            ...
            @Override
            protected void onBindViewHolder (@NonNull AtticViewHolder holder,int position,
                                             @NonNull
                                                     Attic model){
    ...
    public class AtticViewHolder extends RecyclerView.ViewHolder {
        ...
        public AtticViewHolder(@NonNull View itemView) {
            ...
            post_image = itemView.findViewById(R.id.userImage);
        ...
        public void setPostImage(Context ctx, String postImage) {
            Picasso.with(ctx).load(postImage).into((Target) post_image);
        }
