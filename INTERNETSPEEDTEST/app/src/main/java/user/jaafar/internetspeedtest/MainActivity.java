package user.jaafar.internetspeedtest;
            ...
            public void onClick(View v) {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        //get user.jaafar.internetspeedtest host
                        ...
                        //Init Test
                        final user.jaafar.internetspeedtest.PingTest pingTest = new user.jaafar.internetspeedtest.PingTest(info.get(6).replace(":8080", ""), 3);
                        final user.jaafar.internetspeedtest.HttpDownloadTest downloadTest = new user.jaafar.internetspeedtest.HttpDownloadTest(testAddr.replace(testAddr.split("/")[testAddr.split("/").length - 1], ""));
                        final user.jaafar.internetspeedtest.HttpUploadTest uploadTest = new user.jaafar.internetspeedtest.HttpUploadTest(testAddr);
